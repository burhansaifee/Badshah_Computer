...
// --- Sub-components (These are all correct and can be left as is) ---
...
// --- Main AdminDashboard Component (CORRECTED PROPS) ---
export function AdminDashboard({ 
  ...
  return (
    <div className="admin-dashboard">
      ...
      {activeTab === 'bookings' && <BookingsManager bookings={bookings} onStatusChange={onStatusChange} onViewDetails={setSelectedBooking} onDelete={onDeleteBooking} />}
      {activeTab === 'orders' && <OrdersManager orders={orders} onUpdateStatus={onUpdateOrderStatus} onViewDetails={setSelectedOrder} onDelete={onDeleteOrder} />}
